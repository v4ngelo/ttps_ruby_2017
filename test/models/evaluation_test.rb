...
class EvaluationTest < ActiveSupport::TestCase
  ...
  test "valid evaluation" do
    evaluation = Evaluation.new(title: "Evaluation title", evaluation_date: date, minimum_note: 1, course_id: @course.id)
    assert evaluation.valid?
  end

  test "invalid - old evaluation date" do
    evaluation = Evaluation.new(title: "Evaluation title", evaluation_date: old_date, minimum_note: 1, course_id: @course.id)
  ...
  test "invalid - absent evaluation date" do
    evaluation = Evaluation.new(title: "Evaluation title", evaluation_date: "", minimum_note: 1, course_id: @course.id)
    refute evaluation.valid?, 'The evaluation has an empty date'
    assert_not_nil evaluation.errors[:evaluation_date]
  end

  test "invalid - absent evaluation date not a date" do
    evaluation = Evaluation.new(title: "Evaluation title", evaluation_date: "asdf", minimum_note: 1, course_id: @course.id)
    refute evaluation.valid?, 'The evaluation has an invalid date'
    assert_not_nil evaluation.errors[:evaluation_date]
  end

  test "invalid - asbsent title" do
    evaluation = Evaluation.new(title: "", evaluation_date: date, minimum_note: 1, course_id: @course.id)
  ...
  test "invalid evaluation - minimum note absent" do
    evaluation = Evaluation.new(title: "Evaluation title", evaluation_date: date, minimum_note: "", course_id: @course.id)
  ...
  test "invalid evaluation - minimum note not a number" do
    evaluation = Evaluation.new(title: "Evaluation title", evaluation_date: date, minimum_note: "a", course_id: @course.id)
